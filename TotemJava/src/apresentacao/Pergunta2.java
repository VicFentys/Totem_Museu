...
public class Pergunta2 extends javax.swing.JDialog {
    ...
    public Pergunta2(java.awt.Frame parent, boolean modal, int resCorretaTotal) {
        super(parent, false);
        initComponents();
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (txfResposta.getText().trim().equals("estudar a geologia do planeta")){
            ...
            new Info2(null, true, resCorretas).setVisible(true); // Chama o próximo JDialog mandando a quantidade de acertos para ele
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pergunta2 dialog = new Pergunta2(new javax.swing.JFrame(), true, 0);
