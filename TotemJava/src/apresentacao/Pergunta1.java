...
public class Pergunta1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jrBtn1.setText(" Spirit");
        jrBtn1.setContentAreaFilled(false);
        getContentPane().add(jrBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 100, -1));
        ...
        jrBtn2.setText(" Sojourner");
        getContentPane().add(jrBtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 240, 150, -1));
        ...
        jrBtn3.setText(" Curiosity");
        getContentPane().add(jrBtn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, 130, -1));
        ...
        jrBtn4.setText(" Perseverance");
        getContentPane().add(jrBtn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 320, -1, -1));
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (!jrBtn1.isSelected() && !jrBtn2.isSelected() &&
            ...
            new Info1(null, true).setVisible(true); // Chama o próximo JDialog
            this.dispose();
        }
        else {
            new Info1(null, true).setVisible(true); // Chama o próximo JDialog
