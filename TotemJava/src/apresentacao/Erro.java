...
public class Erro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txt1.setText("<html> <div style= 'text-align: center'> <p>Marque uma das <br/> <p style='margin-top: 10'>opções de resposta.");
        getContentPane().add(txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
