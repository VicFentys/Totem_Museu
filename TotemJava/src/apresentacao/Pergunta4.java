...
public class Pergunta4 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnGroup4.add(jrBtn1);
        jrBtn1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jrBtn1.setForeground(new java.awt.Color(239, 236, 236));
        jrBtn1.setText(" NASA");
        getContentPane().add(jrBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 110, -1));

        btnGroup4.add(jrBtn2);
        jrBtn2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jrBtn2.setForeground(new java.awt.Color(239, 236, 236));
        jrBtn2.setText(" ESA");
        getContentPane().add(jrBtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 240, 80, -1));

        btnGroup4.add(jrBtn3);
        ...
        btnGroup4.add(jrBtn4);
        jrBtn4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jrBtn4.setForeground(new java.awt.Color(239, 236, 236));
        jrBtn4.setText(" ISRO");
        getContentPane().add(jrBtn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 320, 90, -1));
