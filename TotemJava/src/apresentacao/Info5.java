...
public class Info5 extends javax.swing.JDialog {
    ...
    public Info5(java.awt.Frame parent, boolean modal, int resCorretaTotal) {
        super(parent, false);
        initComponents();
    ...
    private void btnProximaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximaActionPerformed
        new Feedback(null, true, resCorretas).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Info5 dialog = new Info5(new javax.swing.JFrame(), true, 0);
