...
public class Errada extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txt2.setText("Resposta errada, (explicação da resposta correta)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Errada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
